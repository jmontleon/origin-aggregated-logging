...
openssl rand 16 | openssl enc -aes-128-cbc -nosalt -out es-logging/searchguard.key -pass pass:pass
openssl rand 16 | openssl enc -aes-128-cbc -nosalt -out es-ops/searchguard.key -pass pass:pass
